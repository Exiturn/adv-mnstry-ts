...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex justify-center items-center bg-[#f4f4f4] rounded-full w-[7rem] h-[7rem] p-4 uppercase text-center font-bold leading-tight duration-75 ease-linear heroCta"
        style={{
